#Chisa (FTP)
# Tambahkan file protocol7_manifesto.txt
==================================================
...
# Opsi 1: Tidak bisa mendownload file di Mika
cp /root/protocol7_manifesto.txt /home/mika/
chown mika:mika /home/mika/protocol7_manifesto.txt

# Opsi 2: Tidak bisa mendownload file di Mika
mkdir -p /home/ftp
